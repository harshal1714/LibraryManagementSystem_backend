...
public class TransactionService {
    ...
    public IssueBookResponseDto issueBook(IssueBookRequestDto issueBookRequestDto) throws Exception {
        ...
        String textforemail="Congratuations !!"+ card.getStudent().getName()+" You Issued Boook"+book.getTitle()+"Book";

        SimpleMailMessage message = new SimpleMailMessage();
        message.setFrom("harshalkamdi1714@gmail.com");
        message.setTo(card.getStudent().getEmail());
        message.setSubject("Notification of Book Issued");
        message.setText(textforemail);
